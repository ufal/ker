...
if __name__ == '__main__':
    ...
    if os.path.exists(args.cs_morphodita):
        ...
        print >> sys.stderr, "File with Czech Morphodita model does not exist: {}".format(
            args.cs_morphodita)
        exit(1)
    ...
    if os.path.exists(args.cs_idf):
        ...
        print >> sys.stderr, "File with Czech IDF model does not exist: {}".format(
            args.cs_idf)
        exit(1)
    ...
    if os.path.exists(args.en_morphodita):
        ...
        print >> sys.stderr, "File with English Morphodita model does not exist: {}".format(
            args.en_morphodita)
        exit(1)
    ...
    if os.path.exists(args.en_idf):
        ...
        print >> sys.stderr, "File with English IDF model does not exist: {}".format(
            args.en_idf)
        exit(1)
